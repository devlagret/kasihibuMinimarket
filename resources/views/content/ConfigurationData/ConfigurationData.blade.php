...
<script>
  ...
  function buttonClick(name) {
    ...
    hideButton();
    $('#close_cashier_temp').html('<span class=\'spinner-grow spinner-grow-sm mb-1\' role=\'status\' aria-hidden=\'true\'></span> Proses ...');
     ...
     hideButton();
      ...
      $.ajax({
          ...
          if (data == 0) {
            ...
            $('#modal-body').text('Shift 1 Sudah Ditutup, Shift 2 Masih Berlangsung Panjang');
            $('.modal-body').text('Shift 1 Sudah Ditutup, Shift 2 Masih Berlangsung Panjang');
...
{{-- {{session('data')}}   --}}
  <button onclick="buttonClick('close_cashier_temp');" id="close_cashier_temp" class="btn btn-success btn-lg mx-2"><i class="fa fa-archive"></i> Tutup kasir 03-07-2023 shift 2</button>
