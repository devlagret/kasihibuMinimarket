...
class ConsolidatedProfitLossReportController extends Controller
{
    ...
    public function index()
    {
        ...
        // $profit_mi = curl_init();
        // curl_setopt($profit_mi, CURLOPT_URL,'https://127.0.0.1:8000/kasihibu_minimarket/api/get-data-profit-loss-report');
        ...
        // $profit_mo = curl_init();
        // curl_setopt($profit_mo, CURLOPT_URL,'https://127.0.0.1:8000/kasihibu_mozaic/api/get-data-profit-loss-report');
    ...
    public function getAmountAccount($account_id1, $account_id2)
    {
        ...
        curl_setopt($journal_mi, CURLOPT_URL,'https://127.0.0.1:8000/kasihibu_minimarket/api/get-data-journal-voucher');
        ...
        $journal_mo = curl_init();
        curl_setopt($journal_mo, CURLOPT_URL,'https://127.0.0.1:8000/kasihibu_mozaic/api/get-data-journal-voucher');
        curl_setopt($journal_mo, CURLOPT_RETURNTRANSFER, true);
        $response_journal_mo = curl_exec($journal_mo);
        $result_journal_mo = json_decode($response_journal_mo,TRUE);
        curl_close($journal_mo);
