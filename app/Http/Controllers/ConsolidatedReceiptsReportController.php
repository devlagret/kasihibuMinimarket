...
class ConsolidatedReceiptsReportController extends Controller
{
    ...
    public function index()
    {
        ...
        curl_setopt($sales_invoice_mi, CURLOPT_URL,'https://127.0.0.1:8000/kasihibu_minimarket/api/get-data-sales-invoice');
        ...
        curl_setopt($sales_invoice_mo, CURLOPT_URL,'https://127.0.0.1:8000/kasihibu_mozaic/api/get-data-sales-invoice');
