...
class ConsolidatedDisbursementReportController extends Controller
{
    ...
    public function index()
    {
        ...
        curl_setopt($expenditure_mi, CURLOPT_URL,'https://127.0.0.1:8000/kasihibu_minimarket/api/get-data-expenditure');
        ...
        curl_setopt($expenditure_mo, CURLOPT_URL,'https://127.0.0.1:8000/kasihibu_mozaic/api/get-data-expenditure');
